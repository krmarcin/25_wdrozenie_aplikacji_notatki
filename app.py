...
def list_notes_from_db(query=None):
    ...
    if not query:
        # scroll zwraca tuple: (lista_punktów, offset)
        scroll_result = qdrant_client.scroll(collection_name=QDRANT_COLLECTION_NAME, limit=10)
        notes = scroll_result[0]  # bierzemy tylko listę punktów
        ...
        # query_points zwraca obiekt QueryResponse
        ...
        # Tutaj punkty siedzą w atrybucie .points
        notes = response.points
